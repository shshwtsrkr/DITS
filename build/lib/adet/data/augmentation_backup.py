...
def gen_crop_transform_with_instance(crop_size, image_size, instances, crop_box=True):
    ...
    if not (image_size[0] >= center_yx[0] and image_size[1] >= center_yx[1]):
        raise BoundingBoxOutsideImageError("The annotation bounding box is outside of the image")
    # You can add additional code here to handle this case
    assert (
    ...
    #     print("Center:", center_yx)
    #     print("Crop Size:", crop_size)

    #     if not (
    #         image_size[0] >= center_yx[0] and image_size[1] >= center_yx[1]
    #     ):
    #         print("Error: Bounding box is outside of the image!")
    #     elif not (image_size[0] >= crop_size[0] and image_size[1] >= crop_size[1]):
    #         print("Error: Crop size is larger than image size!")
...
class RandomCropWithInstance(RandomCrop):
    ...
    def get_transform(self, img, boxes):
        ...
        try:
            ...
            print("Warning: Bounding box outside image. Skipping this image during cropping.")
